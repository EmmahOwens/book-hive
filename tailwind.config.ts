  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        neumorphic: "8px 8px 16px hsl(220 15% 85%), -8px -8px 16px hsl(220 15% 100%)",
        "neumorphic-inset": "inset 8px 8px 16px hsl(220 15% 85%), inset -8px -8px 16px hsl(220 15% 100%)",
        glass: "0 8px 32px hsl(211 100% 50% / 0.1)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      fontSize: {
        "display-large": ["5rem", { lineHeight: "1.1", letterSpacing: "-0.025em" }],
        "display-medium": ["3.5rem", { lineHeight: "1.1", letterSpacing: "-0.02em" }],
        "display-small": ["2.5rem", { lineHeight: "1.2", letterSpacing: "-0.015em" }],
      },
